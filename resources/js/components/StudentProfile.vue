      ...
      <div class="course-content">
        ...
        <div class="course-assistance">
          ...
          <div class="profile-actions">
            ...
            >Check Out</button>
            <a :href="'/upload'" class="btn primary-button">Subir Justificación</a>
          </div>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    ...
    checkin(student) {
      axios
        .post("/api/students/" + student.id + "/checkin", this.student)
        .then((response) => {
          location.reload();
        });
    },
    checkout(student) {
      axios
        .patch("/api/students/" + student.id + "/checkout", this.student)
        .then((response) => {
          location.reload();
        });
    },
